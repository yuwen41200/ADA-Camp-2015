					...
					<form class="ui form segment" action="<?php echo $web_root; ?>/index/act/submitFormAction" method="post">
						...
						<div class="field">
							<div class="ui labeled input">
								...
								<input name="note" type="text" placeholder="對什麼食物過敏，營期間有哪些時段不能到等等，非必填">
							</div>
						</div>
