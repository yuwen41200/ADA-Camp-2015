	...
	<div class="ui info message">
		...
		<form class="ui form" name="sendForm" action="<?php echo $web_root; ?>/index/ctl/enroll/act/submitFormAction" method="post">
			<div class="grouped fields">
				...
				<div class="field">
					<div class="ui radio checkbox">
						<input type="radio" name="1B" checked="" tabindex="0" class="hidden">
						<label>文字編輯器 Editors</label>
					</div>
				</div>
				<div class="field">
					<div class="ui radio checkbox">
						<input type="radio" name="1B" tabindex="0" class="hidden">
			...
			<div class="grouped fields">
				...
				<div class="field">
					<div class="ui radio checkbox">
						<input type="radio" name="2AB" checked="" tabindex="0" class="hidden">
						<label>函數程式語言 Functional Programing</label>
					</div>
				</div>
				<div class="field">
					<div class="ui radio checkbox">
						<input type="radio" name="2AB" tabindex="0" class="hidden">
			...
			<div class="grouped fields">
				...
				<div class="field">
					<div class="ui radio checkbox">
						<input type="radio" name="2CD" checked="" tabindex="0" class="hidden">
						<label>3D 繪圖 3ds Max</label>
					</div>
				</div>
				<div class="field">
					<div class="ui radio checkbox">
						<input type="radio" name="2CD" tabindex="0" class="hidden">
			...
			<div class="grouped fields">
				...
				<div class="field">
					<div class="ui radio checkbox">
						<input type="radio" name="3AB" checked="" tabindex="0" class="hidden">
						<label>Workshop: Building a Graduation Ceremony Website</label>
					</div>
				</div>
				<div class="field">
					<div class="ui radio checkbox">
						<input type="radio" name="3AB" tabindex="0" class="hidden">
			...
			<div class="grouped fields">
				...
				<div class="field">
					<div class="ui radio checkbox">
						<input type="radio" name="4AB" checked="" tabindex="0" class="hidden">
						<label>程式語言入門 Python Guide</label>
					</div>
				</div>
				<div class="field">
					<div class="ui radio checkbox">
						<input type="radio" name="4AB" tabindex="0" class="hidden">
			...
			<div class="grouped fields">
				...
				<div class="field">
					<div class="ui radio checkbox">
						<input type="radio" name="4CD" checked="" tabindex="0" class="hidden">
						<label>影片剪輯觀念 Film Editing Concepts</label>
					</div>
				</div>
				<div class="field">
					<div class="ui radio checkbox">
						<input type="radio" name="4CD" tabindex="0" class="hidden">
